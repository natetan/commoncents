package edu.washington.ischool.commoncents.commoncents.controllers1;
 ...
 */
public class EventSummaryPagerController {

    static final String TAG = "EventSummaryPagerController";
